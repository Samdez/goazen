      ...
      <div className={cn(darkerGrotesque.className, 'max-w-full mx-auto px-6 py-8 text-gray-800')}>
        {regionParam === 'pays-basque' ? (
          <div className="prose max-w-none">
            ...
            <p className="mb-4">
              Le Pays Basque, terre de traditions et de modernité, offre une scène musicale vibrante
              et diversifiée. De Biarritz à Bayonne, en passant par Saint-Jean-de-Luz et Hendaye,
              chaque ville contribue à créer un paysage musical unique où se mêlent musiques
              traditionnelles basques et sonorités contemporaines.
            </p>

            <h3 className="text-xl font-bold mb-3">Une scène musicale riche et variée</h3>
            <p className="mb-4">
              La région regorge de salles de concert emblématiques et de lieux culturels dynamiques.
              L&apos;Atabal à Biarritz, les Arènes de Bayonne, ou encore le Magnéto à Bayonne
              proposent une programmation éclectique allant du rock à l&apos;électro, en passant par
              le jazz et les musiques du monde. Les bars et clubs de la côte basque sont également
              réputés pour leurs soirées animées et leurs DJ sets qui font vibrer les nuits basques.
            </p>
            ...
            <p className="mb-4">
              Le Pays Basque s&apos;anime tout au long de l&apos;année avec des événements musicaux
              majeurs. Les fêtes de Bayonne, le festival EHZ, ou encore le FestiLasai sont autant
              d&apos;occasions de découvrir des artistes locaux et internationaux. L&apos;été, les
              concerts en plein air se multiplient, offrant des moments magiques entre mer et
              montagne, tandis que l&apos;hiver, les salles couvertes prennent le relais avec une
              programmation tout aussi riche.
            </p>

            <h3 className="text-xl font-bold mb-3">Une culture musicale unique</h3>
            <p className="mb-4">
              La musique au Pays Basque, c&apos;est aussi la rencontre entre tradition et modernité.
              Les groupes de rock basque côtoient les DJ sets électro, créant une identité musicale
              unique. Les bars se transforment en lieux de concerts, les places des villages
              accueillent des concerts improvisés, et les frontons deviennent des scènes à ciel
              ouvert.
            </p>
            ...
            <p className="mb-4">
              ...
              concert ou une soirée qui vous correspond. Consultez les dates, réservez vos places et
              vivez des moments inoubliables au rythme de la musique basque !
            </p>
          </div>
        ) : (
          <div className="prose max-w-none">
            ...
            <p className="mb-4">
              ...
              ville propose une programmation musicale riche qui anime les soirées landaises tout au
              long de l&apos;année.
            </p>

            <h3 className="text-xl font-bold mb-3">Une scène musicale en plein essor</h3>
            <p className="mb-4">
              La région compte de nombreux lieux dédiés à la musique live et aux DJ sets. Les clubs
              d&apos;Hossegor, les salles de concert de Capbreton et les bars musicaux de Seignosse
              contribuent à faire vivre une scène musicale variée, où se côtoient rock, électro,
              reggae et musiques actuelles.
            </p>
            ...
            <p className="mb-4">
              ...
              l&apos;océan, tandis que l&apos;arrière-saison accueille des concerts plus intimistes
              dans les salles mythiques de la région.
            </p>
          </div>
        )}
      </div>
