...
export default function Page() {
  return (
    <div className="prose prose-sm mx-auto max-w-[100ch]">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Goazen.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Goazen, accessible from{' '}
            <Link href="https://goazen.info">https://goazen.info</Link>
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: samuel.dezaldua@gmail.com</li>
      </ul>
    </div>
  )
}
